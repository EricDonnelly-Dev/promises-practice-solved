...
/**
 * @task
 * Use a correct PROMISE shortcut that will log 
 * and return an array of all promises statuses and values/reasons;
 */
...
export const newPromiseArr = promiseArr.filter((val) => val === promise4);
